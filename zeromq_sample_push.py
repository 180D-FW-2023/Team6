...
while True:
    try:
        ...
        for chunk in buffer_chunks[0: 60]:
            ...
            socket.send_string(both_notes_string)          
...
while True:
    ...
    detected_note = 'C4'  # Example detected note
    socket.send_string(detected_note)  # Sending the note as a string

    # Wait a bit before sending the next message (for demonstration purposes)
    time.sleep(1)
